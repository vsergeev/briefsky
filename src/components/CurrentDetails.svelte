...
<div
  class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-none lg:grid-flow-col place-items-stretch lg:justify-center w-4/5 lg:w-full gap-2 lg:gap-8 mx-auto lg:mx-0 mb-6"
>
